...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://github.com/MyPureCloud/mobile-messenger-ios-sdk/releases/download/v2.2.0/GenesysCloud.zip",
            checksum: "28b6cf1ef8695eea10c812c2e62fac53bafed9159facbcae21dd1ff273cf99e9"
        ),
        .target(
