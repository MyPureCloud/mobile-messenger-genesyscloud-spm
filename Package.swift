...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloud",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.prod/GenesysCloud/GenesysCloud-2.1.0.zip",
            checksum: "11008a2dea153c9bef77b3db167d96e7663a42683cf831639449272b7a35b97e"
        ),
        .target(
